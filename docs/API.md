...
- [x] /d2l/api/le/(version)/(orgUnitId)/content/toc [GET]
...
- [x] /d2l/api/lp/(version)/enrollments/myenrollments/ [GET]
- [x] /d2l/api/lp/(version)/enrollments/myenrollments/(orgUnitId) [GET]
...
- [x] (Not Authorized) /d2l/api/lp/(version)/enrollments/orgUnits/(orgUnitId)/users/ [GET]
- [x] (Not Authorized) /d2l/api/lp/(version)/enrollments/orgUnits/(orgUnitId)/users/(userId) [DELETE]
- [x] (Not Authorized) /d2l/api/lp/(version)/enrollments/orgUnits/(orgUnitId)/users/(userId) [GET]
